                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('images/collections/collection-1.jpg') }}" src="{{ asset('images/collections/collection-1.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('images/collections/collection-2.jpg') }}" src="{{ asset('images/collections/collection-2.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{ asset('images/products/brown-2.jpg') }}" src="{{ asset('images/products/brown-2.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{ asset('images/products/brown-3.jpg') }}" src="{{ asset('images/products/brown-3.jpg') }}" alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                                <span>M</span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="{{ asset('images/products/brown-2.jpg') }}" src="{{ asset('images/products/brown-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('images/products/white-5.jpg') }}" src="{{ asset('images/products/white-5.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>

<x-layout :title="$title" :description="$description" :keywords="$keywords">
    <x-site.partial.header />
    <x-site.components.hero-slider :slides="$heroSlides" />
    <x-site.components.collection-grid :collections="$collections" />
    <x-site.components.shop-collectionbanner
    ...
    />
    <x-site.components.product-carousel
        :products="$bestSellers"
        title="Best Seller"
        section-class="flat-spacing-2 pt_0"
    />
    <x-site.components.banner-collection
        :banners="$bannerCollection"
    />
    <x-site.components.store-locations
        :stores="$stores"
    />
    <x-site.components.brand-logos
        :brands="$brands"
    />
    <x-site.partial.footer />
</x-layout>
